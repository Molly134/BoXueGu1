...
public class FindPswActivity extends AppCompatActivity {
    ...
    private String from;// from的作用是判断界面是从保密界面跳转过来的还是从登录界面跳转过来的,当from为security时界面是从设置保密界面跳转过来的，否则就是从登录状态跳转过来的
    ...
    private void savePsw(String userName){
        String md5Psw= MD5Utils.md5("123456");// 加密密码
